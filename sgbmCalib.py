...
cv.createTrackbar('Blocksize','Disparity',0,100,nothing)
cv.createTrackbar('numDisparities','Disparity',1,256,nothing)
...
cv.createTrackbar('P1Mod', 'Disparity',0,100,nothing)
cv.createTrackbar('P2Mod', 'Disparity',0,100,nothing)
...
while run: 
	...
	P1Mod = cv.getTrackbarPos('P1Mod','Disparity')
	P2Mod = cv.getTrackbarPos('P2Mod','Disparity')
	...
	P1 = P1Mod * blocksize**2
	P2 = P2Mod * blocksize**2
...
cv.imwrite('images/sgbmCalib/sgbmDisp.png',norm_image)
cv.imwrite('images/sgbmCalib/sgbmFiltered.png',filtered_disp)
cv.imwrite('images/sgbmCalib/sgbm_left_raw.png',imgL)

cv_file = cv.FileStorage("calib/sgbmCalib.txt",cv.FileStorage_WRITE)
